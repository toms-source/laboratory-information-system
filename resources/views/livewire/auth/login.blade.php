<form class="border bg-white shadow-md rounded" wire:submit.prevent="login">
   ...
   <div class="button flex items-center justify-center gap-1 px-10 mt-1">
      ...
      <a href="http://localhost:8000/auth/facebook/redirect" class=" text-xs text-white bg-[#3b5998] hover:bg-[#3b5998]/90 focus:ring-4 focus:outline-none focus:ring-[#3b5998]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex 
