<form class="border bg-white shadow-md rounded" wire:submit.prevent="login">
    ...
    <div class="m-5">
        ...
        <input
            class="shadow appearance-none rounded-lg border sm:text-md w-full py-2 px-3 text-gray-700 leading-tight @error('password') border-red-600 @enderror focus:outline-none focus:shadow-outline"
    ...
    <div class="ms-5 me-5">
        <button type="submit"
            class="w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-14 rounded">LOGIN</button>
    </div>
    ...
    <div class="flex items-center justify-center ms-5 me-5">
        <a href="http://127.0.0.1:8000/auth/github/redirect"
    ...
    <div class="py-5 block text-center">
        Don't have an account? <button class="font-semibold text-md text-blue-500 hover:text-blue-800"
            wire:click.prevent="switchToRegister">
            Sign Up
        </button>
    </div>
</form>
